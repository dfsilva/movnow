...
public class AsyncExecutor
{
    public static class Builder
    {
        ...
        public AsyncExecutor build()
        {
            ...
            return new AsyncExecutor(threadPool, eventBus, failureEventType, null);
        }
    ...
    private AsyncExecutor(Executor executor, EventBus eventbus, Class class1)
    {
        threadPool = executor;
        eventBus = eventbus;
        try
    ...
    AsyncExecutor(Executor executor, EventBus eventbus, Class class1, AsyncExecutor asyncexecutor)
    {
        this(executor, eventbus, class1);
    }
