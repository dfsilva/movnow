...
public class ErrorDialogManager
{
    ...
    public static class SupportManagerFragment extends android.support.v4.app.Fragment
    {
        ...
        public static void attachTo(Activity activity, boolean flag, Bundle bundle)
        {
            ...
            SupportManagerFragment supportmanagerfragment = (SupportManagerFragment)fragmentmanager.findFragmentByTag("de.greenrobot.eventbus.error_dialog_manager");
    ...
    public static void attachTo(Activity activity, boolean flag, Bundle bundle)
    {
        ...
        {
            SupportManagerFragment.attachTo(activity, flag, bundle);
            return;
        } else
        {
            HoneycombManagerFragment.attachTo(activity, flag, bundle);
            return;
        }
    }
