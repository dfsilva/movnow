...
# instance fields
.field private c:Lcn/sharesdk/framework/utils/g;
...
.method private constructor <init>(Lcn/sharesdk/framework/Platform;)V
    ...
    iput-object v0, p0, Lcn/sharesdk/twitter/e;->c:Lcn/sharesdk/framework/utils/g;

    invoke-static {}, Lcn/sharesdk/framework/network/k;->a()Lcn/sharesdk/framework/network/k;

    move-result-object v0

    iput-object v0, p0, Lcn/sharesdk/twitter/e;->d:Lcn/sharesdk/framework/network/k;
...
.method public a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcn/sharesdk/twitter/e;->c:Lcn/sharesdk/framework/utils/g;

    invoke-virtual {v0, v1, v2}, Lcn/sharesdk/framework/utils/g;->a(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/util/ArrayList;

    move-result-object v0

    iget-object v3, p0, Lcn/sharesdk/twitter/e;->c:Lcn/sharesdk/framework/utils/g;

    invoke-virtual {v3, v0}, Lcn/sharesdk/framework/utils/g;->a(Ljava/util/ArrayList;)Ljava/util/ArrayList;

    move-result-object v4

    iget-object v0, p0, Lcn/sharesdk/twitter/e;->d:Lcn/sharesdk/framework/network/k;
    ...
    invoke-virtual/range {v0 .. v6}, Lcn/sharesdk/framework/network/k;->a(Ljava/lang/String;Ljava/util/ArrayList;Lcn/sharesdk/framework/network/f;Ljava/util/ArrayList;Ljava/lang/String;I)Ljava/lang/String;
    :try_end_0
...
.method public a(IILjava/lang/String;)Ljava/util/HashMap;
    ...
    :try_start_0
    invoke-static {p3}, Lcn/sharesdk/framework/utils/R;->parseLong(Ljava/lang/String;)J
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v3, v5, v0}, Lcn/sharesdk/framework/network/f;-><init>(Ljava/lang/String;Ljava/lang/Object;)V

    invoke-virtual {v2, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, p0, Lcn/sharesdk/twitter/e;->c:Lcn/sharesdk/framework/utils/g;

    invoke-virtual {v0, v1, v2}, Lcn/sharesdk/framework/utils/g;->b(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method public a(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;Ljava/util/HashMap;)Ljava/util/HashMap;
    ...
    invoke-virtual {v0, p1, v2}, Lcn/sharesdk/framework/utils/g;->b(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/util/ArrayList;

    move-result-object v0

    iget-object v1, p0, Lcn/sharesdk/twitter/e;->c:Lcn/sharesdk/framework/utils/g;

    invoke-virtual {v1, v0}, Lcn/sharesdk/framework/utils/g;->a(Ljava/util/ArrayList;)Ljava/util/ArrayList;

    move-result-object v0

    new-instance v1, Lcn/sharesdk/framework/network/i;

    invoke-direct {v1}, Lcn/sharesdk/framework/network/i;-><init>()V

    invoke-virtual {v1, p1, v2, v0, v5}, Lcn/sharesdk/framework/network/i;->a(Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, v2}, Lcn/sharesdk/framework/utils/g;->a(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, p1, v0}, Lcn/sharesdk/framework/utils/g;->a(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method public a(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/HashMap;
    ...
    invoke-static {v3, v0}, Lcn/sharesdk/framework/utils/BitmapHelper;->downloadBitmap(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, Lcn/sharesdk/framework/utils/e;->c(Ljava/lang/Object;[Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1, v0}, Lcn/sharesdk/twitter/e;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/util/HashMap;
...
.method public a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcn/sharesdk/framework/utils/g;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcn/sharesdk/framework/utils/g;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public b(Ljava/lang/String;)Ljava/util/HashMap;
    ...
    :try_start_0
    invoke-static {p1}, Lcn/sharesdk/framework/utils/R;->parseLong(Ljava/lang/String;)J
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public b(Ljava/lang/String;Ljava/lang/String;)Ljava/util/HashMap;
    ...
    invoke-direct {v0, v4, p1}, Lcn/sharesdk/framework/network/f;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v4, p2}, Lcn/sharesdk/framework/network/f;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lcn/sharesdk/twitter/e;->c:Lcn/sharesdk/framework/utils/g;

    invoke-virtual {v4, v0}, Lcn/sharesdk/framework/utils/g;->a(Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method public getRedirectUri()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcn/sharesdk/framework/utils/g;->a()Lcn/sharesdk/framework/utils/g$b;

    move-result-object v0

    iget-object v0, v0, Lcn/sharesdk/framework/utils/g$b;->e:Ljava/lang/String;
