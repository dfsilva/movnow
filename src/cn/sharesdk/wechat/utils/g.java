...
public class g
{
    ...
    {
        cn.sharesdk.framework.utils.e.a((new StringBuilder()).append("wechat getAuthorizeToken ==>>").append(s).toString(), new Object[0]);
        Object obj = (new d()).a(s);
    ...
    public void a(Bundle bundle, AuthorizeListener authorizelistener)
    {
        ...
        } else
        {
            ...
            {
                cn.sharesdk.framework.utils.e.c(bundle);
            }
            if (authorizelistener != null)
            {
    ...
    {
        cn.sharesdk.framework.utils.e.c((new StringBuilder()).append("getAuthorizeToken ==>> ").append(s).toString(), new Object[0]);
