    ...
    implements PageIndicator
{
    ...
    {
        this(context, attributeset, 0x7f010023);
    }
    ...
    public CirclePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = ((Resources) (obj)).getColor(0x7f08005a);
        int k = ((Resources) (obj)).getColor(0x7f080059);
        int l = ((Resources) (obj)).getInteger(0x7f0a0005);
        int i1 = ((Resources) (obj)).getColor(0x7f08005b);
        float f = ((Resources) (obj)).getDimension(0x7f090050);
        float f1 = ((Resources) (obj)).getDimension(0x7f09004f);
        boolean flag = ((Resources) (obj)).getBoolean(0x7f070001);
        boolean flag1 = ((Resources) (obj)).getBoolean(0x7f070002);
        attributeset = context.obtainStyledAttributes(attributeset, com.veclink.movnow.healthy_q2.R.styleable.CirclePageIndicator, i, 0);
