...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcn/sharesdk/framework/p;->i:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcn/sharesdk/framework/p;->j:Ljava/util/HashMap;
...
.method static synthetic a(Lcn/sharesdk/framework/p;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcn/sharesdk/framework/p;->k:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic a(Lcn/sharesdk/framework/p;Lcn/sharesdk/framework/statistics/a;Ljava/util/HashMap;Ljava/util/HashMap;)Z
    .locals 1

    invoke-direct {p0, p1, p2, p3}, Lcn/sharesdk/framework/p;->a(Lcn/sharesdk/framework/statistics/a;Ljava/util/HashMap;Ljava/util/HashMap;)Z
...
.method private a(Lcn/sharesdk/framework/statistics/a;Ljava/util/HashMap;Ljava/util/HashMap;)Z
    ...
    iget-object v3, p0, Lcn/sharesdk/framework/p;->k:Ljava/lang/String;
...
.method private j()V
    ...
    iget-object v1, p0, Lcn/sharesdk/framework/p;->k:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcn/sharesdk/framework/p;->k:Ljava/lang/String;
    ...
    :goto_0
    iput-object v0, p0, Lcn/sharesdk/framework/p;->m:Ljava/lang/String;
...
.method private l()V
    ...
    new-instance v0, Lcn/sharesdk/framework/q;

    invoke-direct {v0, p0}, Lcn/sharesdk/framework/q;-><init>(Lcn/sharesdk/framework/p;)V

    invoke-virtual {v0}, Lcn/sharesdk/framework/q;->start()V
...
.method private m()V
    ...
    :try_start_0
    iget-object v2, p0, Lcn/sharesdk/framework/p;->g:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcn/sharesdk/framework/p;->g:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcn/sharesdk/framework/p;->f:Ljava/util/HashMap;
...
.method private n()V
    ...
    iget-object v2, p0, Lcn/sharesdk/framework/p;->k:Ljava/lang/String;

    iget-object v3, p0, Lcn/sharesdk/framework/p;->a:Landroid/os/Handler;

    iget-boolean v4, p0, Lcn/sharesdk/framework/p;->l:Z
...
.method public a(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcn/sharesdk/framework/p;->i:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lcn/sharesdk/framework/p;->i:Ljava/util/HashMap;

    invoke-virtual {v0, p1, p2, v2}, Lcn/sharesdk/framework/n;->a(ILjava/lang/String;Ljava/util/HashMap;)Ljava/lang/String;
...
.method public a(I)V
    ...
    sput p1, Lcn/sharesdk/framework/network/i;->a:I
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2, v2}, Lcn/sharesdk/framework/n;->a(IILjava/util/HashMap;)V
...
.method protected a(Landroid/os/Message;)V
    ...
    :try_start_0
    invoke-direct {p0}, Lcn/sharesdk/framework/p;->m()V

    invoke-direct {p0}, Lcn/sharesdk/framework/p;->n()V
...
.method public a(Ljava/lang/Class;)V
    ...
    iget-object v1, p0, Lcn/sharesdk/framework/p;->j:Ljava/util/HashMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcn/sharesdk/framework/p;->j:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lcn/sharesdk/framework/p;->j:Ljava/util/HashMap;
...
.method public a(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcn/sharesdk/framework/p;->k:Ljava/lang/String;
...
.method public a(Ljava/util/HashMap;)Z
    ...
    iget-object v2, p0, Lcn/sharesdk/framework/p;->b:Lcn/sharesdk/framework/p$a;
    ...
    invoke-virtual {v2, v0}, Lcn/sharesdk/framework/statistics/a;->e(Ljava/lang/String;)Ljava/util/HashMap;

    move-result-object v0

    invoke-direct {p0, v2, v0, p1}, Lcn/sharesdk/framework/p;->a(Lcn/sharesdk/framework/statistics/a;Ljava/util/HashMap;Ljava/util/HashMap;)Z

    move-result v0

    if-eqz v0, :cond_2

    iput-boolean v3, p0, Lcn/sharesdk/framework/p;->o:Z

    new-instance v1, Lcn/sharesdk/framework/r;

    invoke-direct {v1, p0, v2}, Lcn/sharesdk/framework/r;-><init>(Lcn/sharesdk/framework/p;Lcn/sharesdk/framework/statistics/a;)V

    invoke-virtual {v1}, Lcn/sharesdk/framework/r;->start()V
    ...
    invoke-virtual {v2, v3}, Lcn/sharesdk/framework/statistics/a;->f(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lcn/sharesdk/framework/p;->k:Ljava/lang/String;

    invoke-virtual {v2, v4, v3}, Lcn/sharesdk/framework/statistics/a;->a(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v4, Lcn/sharesdk/framework/utils/d;

    invoke-direct {v4}, Lcn/sharesdk/framework/utils/d;-><init>()V

    invoke-virtual {v4, v3}, Lcn/sharesdk/framework/utils/d;->a(Ljava/lang/String;)Ljava/util/HashMap;

    move-result-object v3

    invoke-direct {p0, v2, v3, p1}, Lcn/sharesdk/framework/p;->a(Lcn/sharesdk/framework/statistics/a;Ljava/util/HashMap;Ljava/util/HashMap;)Z

    move-result v0

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcn/sharesdk/framework/p;->o:Z
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_3
    iput-boolean v1, p0, Lcn/sharesdk/framework/p;->o:Z
...
.method public b(I)V
    ...
    sput p1, Lcn/sharesdk/framework/network/i;->b:I
...
.method public b(Z)V
    ...
    iput-boolean p1, p0, Lcn/sharesdk/framework/p;->n:Z
...
.method public b(Ljava/util/HashMap;)Z
    ...
    :try_start_0
    iget-object v0, p0, Lcn/sharesdk/framework/p;->i:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, p1, v2}, Lcn/sharesdk/framework/n;->a(Ljava/util/HashMap;Ljava/util/HashMap;)Z
...
.method public d(Ljava/lang/Class;)V
    ...
    :try_start_2
    iget-object v3, p0, Lcn/sharesdk/framework/p;->g:Ljava/util/HashMap;
...
.method public f()Z
    ...
    iget-boolean v0, p0, Lcn/sharesdk/framework/p;->n:Z
...
.method public h()Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcn/sharesdk/framework/p;->o:Z
...
.method public i()V
    ...
    invoke-static {v0}, Lcn/sharesdk/framework/utils/R;->clearCache(Landroid/content/Context;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
