...
public class DefaultConfigurationFactory
{
        ...
        implements ThreadFactory
    {
        ...
        DefaultThreadFactory(int i)
        {
            ...
            namePrefix = (new StringBuilder()).append("pool-").append(poolNumber.getAndIncrement()).append("-thread-").toString();
        }
    }
    ...
    public static MemoryCacheAware createMemoryCache(int i)
    {
        ...
        {
            return new LRULimitedMemoryCache(j);
        }
    }
    ...
    public static DiscCacheAware createReserveDiscCache(Context context)
    {
        ...
        return new TotalSizeLimitedDiscCache(context, 0x200000);
    }
