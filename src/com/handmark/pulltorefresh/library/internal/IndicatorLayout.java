    ...
    implements android.view.animation.Animation.AnimationListener
{
    ...
    public IndicatorLayout(Context context, com.handmark.pulltorefresh.library.PullToRefreshBase.Mode mode)
    {
        ...
        drawable = getResources().getDrawable(0x7f0200c1);
        mArrowImageView.setImageDrawable(drawable);
        int i = getResources().getDimensionPixelSize(0x7f09004c);
...
_L1:
        ...
        j = 0x7f04000b;
        k = 0x7f04000d;
        setBackgroundResource(0x7f0200c3);
_L4:
...
_L2:
        j = 0x7f04000a;
        k = 0x7f04000c;
        setBackgroundResource(0x7f0200c2);
