...
_L3:
        ...
        if (!mode.permitsPullToRefresh() || flag || l1 == 0) goto _L6; else goto _L5
_L5:
        l1 += i2;
        Log.d("OverscrollHelper", (new StringBuilder()).append("OverScroll. DeltaX: ").append(i).append(", ScrollX: ").append(j).append(", DeltaY: ").append(k).append(", ScrollY: ").append(l).append(", NewY: ").append(l1).append(", ScrollRange: ").append(i1).append(", CurrentScroll: ").append(k1).toString());
...
_L7:
        if (mode.showHeaderLoadingLayout())
        {
            ...
            pulltorefreshbase.setHeaderScroll((int)((float)(k1 + l1) * f));
        }
_L4:
        return;
_L2:
...
_L9:
        ...
        pulltorefreshbase.setHeaderScroll((int)((float)((k1 + l1) - i1) * f));
        return;
