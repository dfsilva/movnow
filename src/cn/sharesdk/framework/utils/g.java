...
public class g
{
    public static final class a extends Enum
    {
        ...
        {
            return (a)Enum.valueOf(cn/sharesdk/framework/utils/g$a, s);
        }
    ...
    private ArrayList a(long l, String s)
    {
        ...
        arraylist.add(new f("oauth_consumer_key", a.a));
        arraylist.add(new f("oauth_signature_method", s));
        arraylist.add(new f("oauth_timestamp", String.valueOf(l / 1000L)));
        arraylist.add(new f("oauth_nonce", String.valueOf(l)));
        arraylist.add(new f("oauth_version", "1.0"));
        s = a.c;
        if (s != null && s.length() > 0)
        {
            arraylist.add(new f("oauth_token", s));
        }
        return arraylist;
    }
    ...
    private ArrayList a(long l, ArrayList arraylist, String s)
    {
        ...
        {
            f f1;
            for (arraylist = arraylist.iterator(); arraylist.hasNext(); hashmap.put(a(f1.a), a((String)f1.b)))
            {
                f1 = (f)arraylist.next();
            }
        ...
        if (arraylist != null)
        {
            for (arraylist = arraylist.iterator(); arraylist.hasNext(); hashmap.put(a(((f) (s)).a), a((String)((f) (s)).b)))
            {
                s = (f)arraylist.next();
            }
...
_L5:
        s = a(l, s);
        s.add(new f("oauth_signature", s1));
        return s;
_L2:
        a1 = "HMAC-SHA1";
...
_L4:
    ...
    private String b(ArrayList arraylist)
    {
        ...
        for (int i = 0; arraylist.hasNext(); i++)
        {
            ...
            stringbuilder.append(f1.a).append('=').append((String)f1.b);
        }
    ...
    public ArrayList a(ArrayList arraylist)
    {
        ...
        for (int i = 0; arraylist.hasNext(); i++)
        {
            ...
            String s = a((String)f1.b);
            stringbuilder.append(f1.a).append("=\"").append(s).append("\"");
        }

        arraylist = new ArrayList();
        arraylist.add(new f("Authorization", stringbuilder.toString()));
        arraylist.add(new f("Content-Type", "application/x-www-form-urlencoded"));
        return arraylist;
    }
