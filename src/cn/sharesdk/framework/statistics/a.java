...
public class cn.sharesdk.framework.statistics.a
{
    ...
    private String a(Bitmap bitmap, a a1)
    {
        ...
        {
            cn.sharesdk.framework.utils.e.c(bitmap);
            return null;
        }
        return bitmap;
    }
    ...
    private String a(String s, String s1, String s2, int l, String s3)
    {
        if (!TextUtils.isEmpty(s) && j)
        {
            ...
            if (arraylist.size() != 0)
            {
                ...
                arraylist1.add(new f("key", s1));
                for (int i1 = 0; i1 < arraylist.size(); i1++)
                {
                    arraylist1.add(new f("urls", ((String)arraylist.get(i1)).toString()));
                }

                arraylist1.add(new f("deviceid", cn.sharesdk.framework.utils.b.a(a).p()));
                arraylist1.add(new f("snsplat", String.valueOf(l)));
                cn.sharesdk.framework.utils.e.c("> deviceid  devicekey: %s", new Object[] {
                    cn.sharesdk.framework.utils.b.a(a).p()
                });
                s1 = d(s1, s3);
                if (!TextUtils.isEmpty(s1))
                {
                    arraylist1.add(new f("m", s1));
                    s1 = new ArrayList();
                    s1.add(new f("User-Agent", c));
                    s3 = new ArrayList();
                    s3.add(new f("http.socket.timeout", Integer.valueOf(5000)));
                    s3.add(new f("http.connection.timeout", Integer.valueOf(5000)));
                    try
                    {
                        s1 = k.a(g, arraylist1, null, s1, s3);
                    }
                    // Misplaced declaration of an exception variable
                    catch (String s1)
                    {
                    ...
                    cn.sharesdk.framework.utils.e.c("> SERVER_SHORT_LINK_URL  resp: %s", new Object[] {
                        s1
                    });
                    s1 = (new d()).a(s1);
                    try
                    ...
                    {
                        cn.sharesdk.framework.utils.e.c(s3);
                        l = -1;
                    }
                    if (l == 200)
                    {
                        ...
                        s = s3.toString();
                        cn.sharesdk.framework.utils.e.c("> SERVER_SHORT_LINK_URL content after replace link ===  %s", new Object[] {
                            s
                        });
                        return s;
                    }
    ...
    {
        s = Base64.encodeToString(cn.sharesdk.framework.utils.a.a(abyte0, s), 0);
        abyte0 = s;
        if (s.contains("\n"))
        {
            abyte0 = s.replace("\n", "");
        ...
        s = null;
_L2:
        cn.sharesdk.framework.utils.e.c(abyte0);
        return s;
        abyte0;
...
_L1:
    ...
    private boolean c(String s, String s1)
    {
        ...
        {
            ArrayList arraylist = new ArrayList();
            arraylist.add(new f("m", s));
            arraylist.add(new f("t", s1));
            s = new ArrayList();
            s.add(new f("User-Agent", c));
            s1 = new ArrayList();
            s1.add(new f("http.socket.timeout", Integer.valueOf(30000)));
            s1.add(new f("http.connection.timeout", Integer.valueOf(30000)));
            s = k.a(c(), arraylist, null, s, s1);
            cn.sharesdk.framework.utils.e.b("> %s  resp: %s", new Object[] {
                c(), s
            });
        }
        // Misplaced declaration of an exception variable
    ...
    private String d(String s, String s1)
    {
        ...
        b b1 = cn.sharesdk.framework.utils.b.a(a);
        boolean flag = f.b();
        boolean flag1 = f.c();
        stringbuilder = new StringBuilder();
        try
        {
            stringbuilder.append(cn.sharesdk.framework.utils.a.c(b1.q(), "utf-8")).append("|");
            stringbuilder.append(cn.sharesdk.framework.utils.a.c(b1.t(), "utf-8")).append("|");
            stringbuilder.append(cn.sharesdk.framework.utils.a.c(String.valueOf(ShareSDK.getSDKVersionCode() + 30000), "utf-8")).append("|");
            stringbuilder.append(cn.sharesdk.framework.utils.a.c(String.valueOf(b1.o()), "utf-8")).append("|");
            stringbuilder.append(cn.sharesdk.framework.utils.a.c(b1.n(), "utf-8")).append("|");
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
...
_L1:
        stringbuilder.append(cn.sharesdk.framework.utils.a.c(b1.i(), "utf-8")).append("|");
        stringbuilder.append(cn.sharesdk.framework.utils.a.c(b1.k(), "utf-8")).append("|");
        stringbuilder.append(cn.sharesdk.framework.utils.a.c(b1.c(), "utf-8")).append("|");
        stringbuilder.append(cn.sharesdk.framework.utils.a.c(b1.b(), "utf-8")).append("|");
        stringbuilder.append(cn.sharesdk.framework.utils.a.c(b1.l(), "utf-8")).append("|");
_L3:
        if (!flag1)
        {
...
_L4:
        ...
        cn.sharesdk.framework.utils.e.c("shorLinkMsg ===>>>>", new Object[] {
            s1
        });
        cn.sharesdk.framework.utils.e.c("Base64AES key ===>>>>", new Object[] {
            (new StringBuilder()).append(b1.p()).append(":").append(s).toString()
        });
        return a(s1, cn.sharesdk.framework.utils.a.c(String.format("%s:%s", new Object[] {
            b1.p(), s
        })));
_L2:
    ...
    private String g(String s)
    {
        Object obj = null;
        Object obj1 = h;
        cn.sharesdk.framework.utils.e.b(" upload file , server url = %s, file path = %s", new Object[] {
            obj1, s
        });
        boolean flag;
        try
        {
            s = new f("file", s);
            ArrayList arraylist = new ArrayList();
            arraylist.add(new f("User-Agent", c));
            obj1 = k.a(((String) (obj1)), null, s, arraylist, null);
            cn.sharesdk.framework.utils.e.b("upload file response == %s", new Object[] {
                obj1
            });
        }
        // Misplaced declaration of an exception variable
...
label0:
    ...
    private String i(String s)
    {
        ...
        try
        {
            ...
            jsonobject.put("key", b1.p());
            jsonobject.put("carrier", b1.l());
            jsonobject.put("appkey", s);
            jsonobject.put("apppkg", b1.q());
            jsonobject.put("appver", String.valueOf(b1.s()));
            jsonobject.put("sdkver", ShareSDK.getSDKVersionCode() + 30000);
            jsonobject.put("networktype", b1.n());
        }
        // Misplaced declaration of an exception variable
        catch (String s)
        {
    ...
    private JSONObject i()
    {
        ...
        Object obj = cn.sharesdk.framework.utils.b.a(a);
        try
        {
            jsonobject.put("mac", ((b) (obj)).a());
            jsonobject.put("udid", ((b) (obj)).d());
            jsonobject.put("model", ((b) (obj)).b());
            jsonobject.put("factory", ((b) (obj)).c());
            jsonobject.put("plat", ((b) (obj)).o());
            jsonobject.put("sysver", ((b) (obj)).i());
            jsonobject.put("breaked", false);
            jsonobject.put("screensize", ((b) (obj)).k());
            jsonobject.put("androidid", ((b) (obj)).y());
            obj = ((b) (obj)).z();
        ...
        {
            cn.sharesdk.framework.utils.e.c(jsonexception);
            return jsonobject;
        }
        return jsonobject;
    }
    ...
    public String a(String s, String s1, int l, boolean flag, String s2)
    {
        if (f.g())
        {
            cn.sharesdk.framework.utils.e.c("> SERVER_SHORT_LINK_URL content before replace link ===  %s", new Object[] {
                s
            });
            if (flag)
            {
    ...
    public void a()
    {
        if (f.g() && !"none".equals(cn.sharesdk.framework.utils.b.a(a).n()))
        {
            ArrayList arraylist = cn.sharesdk.framework.statistics.a.e.a(a);
            int l = 0;
            while (l < arraylist.size()) 
            {
                cn.sharesdk.framework.statistics.a.d d1 = (cn.sharesdk.framework.statistics.a.d)arraylist.get(l);
                boolean flag;
                if (d1.b.size() == 1)
                {
                    flag = c(d1.a, "0");
    ...
    public void a(cn.sharesdk.framework.statistics.b.c c1)
    {
        ...
        obj = cn.sharesdk.framework.utils.b.a(a);
        s1 = ((b) (obj)).n();
        cn.sharesdk.framework.utils.e.b(" event string == %s", new Object[] {
            c1.toString()
        });
        if (!(c1 instanceof g) || s1.endsWith("none")) goto _L2; else goto _L1
_L1:
        String s2 = (new StringBuilder()).append(((b) (obj)).q()).append("/").append(((b) (obj)).t()).toString();
        String s3 = (new StringBuilder()).append("ShareSDK/").append(ShareSDK.getSDKVersionName()).toString();
        obj = (new StringBuilder()).append("Android/").append(((b) (obj)).i()).toString();
...
_L4:
        ...
        return;
_L2:
        if (c1 instanceof cn.sharesdk.framework.statistics.b.b)
        {
            boolean flag1 = f.c();
            String s = ((cn.sharesdk.framework.statistics.b.b)c1).c;
            if (flag1 && !TextUtils.isEmpty(s))
            {
                ((cn.sharesdk.framework.statistics.b.b)c1).c = cn.sharesdk.framework.utils.a.b(s, c1.f.substring(0, 16));
            } else
            {
                ((cn.sharesdk.framework.statistics.b.b)c1).d = null;
                ((cn.sharesdk.framework.statistics.b.b)c1).c = null;
            }
        } else
        if (c1 instanceof cn.sharesdk.framework.statistics.b.f)
        {
            cn.sharesdk.framework.statistics.b.f f1 = (cn.sharesdk.framework.statistics.b.f)c1;
            int l = f.d();
            boolean flag2 = f.c();
...
_L3:
    ...
    public void a(String s, ArrayList arraylist)
    {
        ...
        } else
        {
            ...
            s = cn.sharesdk.framework.utils.b.a(a);
            ((HashMap) (obj)).put("plat", Integer.valueOf(s.o()));
            ((HashMap) (obj)).put("device", s.p());
            ((HashMap) (obj)).put("list", arraylist);
            arraylist = (new d()).a(((HashMap) (obj)));
            cn.sharesdk.framework.utils.e.a(" upload apps info == %s", new Object[] {
                arraylist
            });
            s = new ArrayList();
            s.add(new f("m", cn.sharesdk.framework.utils.a.b(arraylist, "sdk.sharesdk.sdk")));
            arraylist = new ArrayList();
            arraylist.add(new f("User-Agent", c));
            obj = new ArrayList();
            ((ArrayList) (obj)).add(new f("http.socket.timeout", Integer.valueOf(30000)));
            ((ArrayList) (obj)).add(new f("http.connection.timeout", Integer.valueOf(30000)));
            cn.sharesdk.framework.utils.e.b("> APPS_UNFINISHED  resp: %s", new Object[] {
                k.a(d(), s, null, arraylist, ((ArrayList) (obj)))
            });
            return;
        }
    }
...
_L2:
        Object obj;
        obj = new ArrayList();
        ((ArrayList) (obj)).add(new f("appkey", s));
        s = new ArrayList();
        s.add(new f("User-Agent", c));
        ArrayList arraylist = new ArrayList();
        arraylist.add(new f("http.socket.timeout", Integer.valueOf(30000)));
        arraylist.add(new f("http.connection.timeout", Integer.valueOf(30000)));
        obj = k.a(g(), ((ArrayList) (obj)), null, s, arraylist);
        s = ((String) (obj));
        if (TextUtils.isEmpty(((CharSequence) (obj))))
        {
            s = "{}";
        ...
        try
        {
            cn.sharesdk.framework.utils.e.b(" get server connection response == %s", new Object[] {
                s
            });
        }
        // Misplaced declaration of an exception variable
...
_L2:
        Object obj1;
        obj1 = cn.sharesdk.framework.utils.b.a(a);
        f.a(System.currentTimeMillis());
        ArrayList arraylist = new ArrayList();
        arraylist.add(new f("appkey", s));
        arraylist.add(new f("device", ((b) (obj1)).p()));
        arraylist.add(new f("plat", String.valueOf(((b) (obj1)).o())));
        arraylist.add(new f("apppkg", ((b) (obj1)).q()));
        arraylist.add(new f("appver", String.valueOf(((b) (obj1)).s())));
        arraylist.add(new f("sdkver", String.valueOf(ShareSDK.getSDKVersionCode() + 30000)));
        arraylist.add(new f("networktype", ((b) (obj1)).n()));
        obj1 = new ArrayList();
        ((ArrayList) (obj1)).add(new f("User-Agent", c));
        ArrayList arraylist1 = new ArrayList();
        arraylist1.add(new f("http.socket.timeout", Integer.valueOf(10000)));
        arraylist1.add(new f("http.connection.timeout", Integer.valueOf(10000)));
        obj1 = k.a(f(), arraylist, null, ((ArrayList) (obj1)), arraylist1);
        Object obj = obj1;
        ...
        try
        {
            cn.sharesdk.framework.utils.e.b(" get server config response == %s", new Object[] {
                obj
            });
        }
        catch (Throwable throwable)
        ...
        {
            cn.sharesdk.framework.utils.e.b(throwable1);
            l = -200;
        }
        if (l != -200)
        {
...
_L7:
    ...
    public String b(String s, String s1)
    {
        ...
        String s2 = cn.sharesdk.framework.utils.b.a(a).p();
        return new String(cn.sharesdk.framework.utils.a.a(cn.sharesdk.framework.utils.a.c((new StringBuilder()).append(s).append(":").append(s2).toString()), s1), "UTF-8");
    }
    ...
    public void c(String s)
    {
        if (f.g())
        {
            try
            {
                ...
                {
                    f.h(((String) (obj)));
                    cn.sharesdk.framework.utils.e.a(" curBaseDeviceInfo == %s", new Object[] {
                        obj
                    });
                    ArrayList arraylist = new ArrayList();
                    arraylist.add(new f("m", cn.sharesdk.framework.utils.a.b(i(s), "sdk.sharesdk.sdk")));
                    s = new ArrayList();
                    s.add(new f("User-Agent", c));
                    obj = new ArrayList();
                    ((ArrayList) (obj)).add(new f("http.socket.timeout", Integer.valueOf(30000)));
                    ((ArrayList) (obj)).add(new f("http.connection.timeout", Integer.valueOf(30000)));
                    cn.sharesdk.framework.utils.e.b("> DEVICE_UNFINISHED  resp: %s", new Object[] {
                        k.a(d(), arraylist, null, s, ((ArrayList) (obj)))
                    });
                    return;
                }
            }
    ...
    public String f(String s)
    {
        ArrayList arraylist = new ArrayList();
        arraylist.add(new f("appkey", s));
        arraylist.add(new f("device", cn.sharesdk.framework.utils.b.a(a).p()));
        s = new ArrayList();
        s.add(new f("User-Agent", c));
        ArrayList arraylist1 = new ArrayList();
        arraylist1.add(new f("http.socket.timeout", Integer.valueOf(10000)));
        arraylist1.add(new f("http.connection.timeout", Integer.valueOf(10000)));
        return k.a(e(), arraylist, null, s, arraylist1);
    }
