    ...
    implements PageIndicator
{
    ...
    {
        this(context, attributeset, 0x7f010025);
    }
    ...
    public LinePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = ((Resources) (obj)).getColor(0x7f08005c);
        int k = ((Resources) (obj)).getColor(0x7f08005d);
        float f = ((Resources) (obj)).getDimension(0x7f090051);
        float f1 = ((Resources) (obj)).getDimension(0x7f090052);
        float f2 = ((Resources) (obj)).getDimension(0x7f090053);
        boolean flag = ((Resources) (obj)).getBoolean(0x7f070003);
        attributeset = context.obtainStyledAttributes(attributeset, com.veclink.movnow.healthy_q2.R.styleable.LinePageIndicator, i, 0);
