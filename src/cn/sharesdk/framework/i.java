...
//            Platform, PlatformDb, d, ShareSDK, 
//            CustomPlatform, k, j, PlatformActionListener
...
public class i
{
    ...
    public i(Platform platform, Context context)
    {
        h = true;
        a = platform;
        b = context;
        ...
        a(s);
        d = new cn.sharesdk.framework.d();
    }

    static boolean a(i l)
    {
        return l.j();
    }

    static Platform b(i l)
    {
        return l.a;
    }
    ...
    {
        boolean flag = false;
        if (!cn.sharesdk.framework.ShareSDK.a())
        {
            return true;
        }
        if (ShareSDK.b())
        ...
        if (!cn.sharesdk.framework.ShareSDK.a(((HashMap) (obj))))
        {
            return false;
        }
        boolean flag1;
...
_L1:
        cn.sharesdk.framework.utils.e.c("user id %s ==>>", new Object[] {
            g().getUserName()
        });
        stringbuilder.append(cn.sharesdk.framework.utils.a.c(g().getUserName(), "utf-8"));
_L3:
        stringbuilder.append("|").append(cn.sharesdk.framework.utils.a.c(g().get("secretType"), "utf-8"));
        stringbuilder.append("|").append(cn.sharesdk.framework.utils.a.c(g().get("gender"), "utf-8"));
        stringbuilder.append("|").append(cn.sharesdk.framework.utils.a.c(g().get("birthday"), "utf-8"));
        stringbuilder.append("|").append(cn.sharesdk.framework.utils.a.c(g().get("educationJSONArrayStr"), "utf-8"));
        stringbuilder.append("|").append(cn.sharesdk.framework.utils.a.c(g().get("workJSONArrayStr"), "utf-8"));
_L4:
        return stringbuilder.toString();
_L2:
        stringbuilder.append(cn.sharesdk.framework.utils.a.c(g().getUserId(), "utf-8"));
          goto _L3
        Throwable throwable;
        throwable;
        cn.sharesdk.framework.utils.e.b(throwable);
...
label0:
        {
            String s2 = cn.sharesdk.framework.ShareSDK.a(l, s);
    ...
    {
        return cn.sharesdk.framework.ShareSDK.a(bitmap);
    }
    ...
    public String a(String s, boolean flag)
    {
        ...
        if (!h)
        {
            cn.sharesdk.framework.utils.e.c((new StringBuilder()).append("getShortLintk use time: ").append(System.currentTimeMillis() - l).toString(), new Object[0]);
            return s;
        }
        ...
        {
            s = cn.sharesdk.framework.ShareSDK.a(s, flag, a.getPlatformId(), k());
            cn.sharesdk.framework.utils.e.c((new StringBuilder()).append("getShortLintk use time: ").append(System.currentTimeMillis() - l).toString(), new Object[0]);
            return s;
        }
    }
...
_L10:
    ...
    {
        return cn.sharesdk.framework.ShareSDK.a(s);
    }
