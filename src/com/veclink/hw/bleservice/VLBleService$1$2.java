    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        deviceOnServicesDiscovered(val$gatt, val$status);
    }
...
_L5:
        ...
        public void onServicesDiscovered(final BluetoothGatt gatt, int i)
        {
            if (i == 0)
            {
                Debug.logBleByTag(VLBleService.access$000(), (new StringBuilder()).append("onServicesDiscovered success: ").append(i).toString());
                ...
                {
                    handler.postDelayed(i. new VLBleService._cls1._cls2(), 1000L);
                } else
                {
            ...
            {
                Log.w(VLBleService.access$000(), (new StringBuilder()).append("onServicesDiscovered received: ").append(i).toString());
                return;
            }
        }
        ...
        // Unreferenced inner class com/veclink/hw/bleservice/VLBleService$1$1

/* anonymous class */
        class VLBleService._cls1._cls1
            implements Runnable
        {
            ...
            public void run()
            {
                if (!VLBleService.access$100(this$0))
                {
                    Debug.logBle("10\u79D2\u540E\u6CA1\u53D1\u73B0\u670D\u52A1\uFF0C\u81EA\u52A8\u65AD\u5F00");
                    disconnect();
                    close();
                    VLBleService.access$200(this$0);
                }
            }
