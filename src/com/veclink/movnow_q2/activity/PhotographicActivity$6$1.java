...
class this._cls1 extends Thread
{
    ...
    public void run()
    {
        ...
        PhotographicActivity.access$502(_fld0, true);
    }
    ...
    // Unreferenced inner class com/veclink/movnow_q2/activity/PhotographicActivity$6

/* anonymous class */
    class PhotographicActivity._cls6 extends BroadcastReceiver
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            if ("net.bestouch.caretracker.cameraCtrActivity.action.CAMERA_CTR_ACTION".equals(intent.getAction()))
            {
                ...
                (new PhotographicActivity._cls6._cls1()).start();
            }
        }
