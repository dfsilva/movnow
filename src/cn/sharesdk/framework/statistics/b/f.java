...
public class f extends c
{
    ...
    public String toString()
    {
        ...
        s = d.toString();
        obj = Base64.encodeToString(cn.sharesdk.framework.utils.a.a(f.substring(0, 16), s), 0);
        s = ((String) (obj));
        try
        {
        ...
        obj = Base64.encodeToString(cn.sharesdk.framework.utils.a.a(f.substring(0, 16), n), 0);
        s = ((String) (obj));
