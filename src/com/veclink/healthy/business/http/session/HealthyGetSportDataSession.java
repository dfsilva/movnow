...
public class HealthyGetSportDataSession extends HealthyCommentSession
{
    ...
    public HealthyGetSportDataSession(Context context, String s, String s1)
    {
        super(com/veclink/healthy/business/http/pojo/GetSportDataResponse, context);
    ...
    public RequestParams getRequestParams()
    {
        ...
        hashmap.put("method", "bracelet.getsportsdata");
        String s = createTimeStamp();
        requestparams.put("method", "bracelet.getsportsdata");
