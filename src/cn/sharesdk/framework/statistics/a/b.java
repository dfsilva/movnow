...
public class b
{
    ...
    public int a(String s, String s1, String as[])
    {
        ...
        e.a("Deleted %d rows from table: %s", new Object[] {
            Integer.valueOf(i), s
        });
        return i;
        s1;
        i = 0;
_L2:
        e.a(s1, "when delete database occur error table:%s,", new Object[] {
            s
        });
        return i;
        s1;
...
_L1:
    ...
    public long a(String s, ContentValues contentvalues)
    {
        ...
        {
            e.a(contentvalues, "when insert database occur error table:%s,", new Object[] {
                s
            });
            return -1L;
        }
    ...
    public Cursor a(String s, String as[], String s1, String as1[], String s2)
    {
        ...
        {
            e.a(as, "when query database occur error table:%s,", new Object[] {
                s
            });
            return null;
        }
