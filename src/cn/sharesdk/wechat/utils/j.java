...
//            WechatClientNotExistException, l, WechatHandlerActivity, b, 
//            k, e, c, f
...
_L1:
    ...
    private boolean a(byte abyte0[], byte abyte1[])
    {
        ...
        {
            e.c("checkSumConsistent fail, invalid arguments, \"_mmessage_checksum\" is empty", new Object[0]);
            return false;
        }
        if (abyte1 == null || abyte1.length == 0)
        {
            e.c("checkSumConsistent fail, invalid arguments, checksum is empty", new Object[0]);
            return false;
        }
        if (abyte0.length != abyte1.length)
        {
            e.c("checkSumConsistent fail, length is different", new Object[0]);
            return false;
        }
        for (int i = 0; i < abyte0.length; i++)
        {
            ...
            {
                e.c("checkSumConsistent fail, not match", new Object[0]);
                return false;
            }
        }
    ...
    {
        boolean flag1 = false;
        e.a("checking signature of wechat client...", new Object[0]);
...
label0:
    ...
    public void a(l l1)
    {
        ...
        e.a("starting activity, packageName=com.tencent.mm, className=com.tencent.mm.plugin.base.stub.WXEntryActivity", new Object[0]);
    }
    ...
    public boolean a()
    {
        ...
        try
        {
            ...
            e.b((new StringBuilder()).append("wechat versionName ==>> ").append(((String) (obj))).toString(), new Object[0]);
        }
        catch (Throwable throwable)
        {
            e.c(throwable);
    ...
    public boolean a(Context context, String s)
    {
        ...
        if (!d())
        {
            e.c("register app failed for wechat app signature check failed", new Object[0]);
            return false;
        } else
        {
            ...
            e.a((new StringBuilder()).append("sending broadcast, intent=").append("com.tencent.mm.plugin.openapi.Intent.ACTION_HANDLE_APP_REGISTER").append(", perm=").append("com.tencent.mm.permission.MM_MESSAGE").toString(), new Object[0]);
            return true;
        }
    }
    ...
    public boolean a(WechatHandlerActivity wechathandleractivity, k k1)
    {
        ...
        {
            e.c("invalid argument, \"wx_token_key\" is empty or does not equals \"com.tencent.mm.openapi.token\"", new Object[0]);
            return false;
        }
        s = ((Intent) (obj)).getStringExtra("_mmessage_appPackage");
        if (TextUtils.isEmpty(s))
        {
            e.c("invalid argument, \"_mmessage_appPackage\" is empty", new Object[0]);
            return false;
        }
        ...
        {
            e.c("checksum fail", new Object[0]);
            return false;
        }
...
_L7:
        return true;
_L3:
        k1.a(new cn.sharesdk.wechat.utils.e(((Bundle) (obj))));
