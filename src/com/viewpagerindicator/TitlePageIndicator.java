    ...
    implements PageIndicator
{
    ...
    public TitlePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = ((Resources) (obj)).getColor(0x7f08005e);
        float f = ((Resources) (obj)).getDimension(0x7f090055);
        int k = ((Resources) (obj)).getInteger(0x7f0a0006);
        float f1 = ((Resources) (obj)).getDimension(0x7f090056);
        float f2 = ((Resources) (obj)).getDimension(0x7f090057);
        float f3 = ((Resources) (obj)).getDimension(0x7f090058);
        int l = ((Resources) (obj)).getInteger(0x7f0a0007);
        int i1 = ((Resources) (obj)).getColor(0x7f08005f);
        boolean flag = ((Resources) (obj)).getBoolean(0x7f070004);
        int j1 = ((Resources) (obj)).getColor(0x7f080060);
        float f4 = ((Resources) (obj)).getDimension(0x7f090059);
        float f5 = ((Resources) (obj)).getDimension(0x7f09005a);
        float f6 = ((Resources) (obj)).getDimension(0x7f090054);
        float f7 = ((Resources) (obj)).getDimension(0x7f09005b);
        attributeset = context.obtainStyledAttributes(attributeset, com.veclink.movnow.healthy_q2.R.styleable.TitlePageIndicator, i, 0);
