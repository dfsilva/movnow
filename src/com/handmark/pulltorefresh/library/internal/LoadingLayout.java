    ...
    implements ILoadingLayout
{
    ...
    //                   1 454;
           goto _L1 _L2
_L1:
        LayoutInflater.from(context).inflate(0x7f03004d, this);
_L5:
        android.widget.FrameLayout.LayoutParams layoutparams;
        mInnerLayout = (FrameLayout)findViewById(0x7f06015c);
        mHeaderText = (TextView)mInnerLayout.findViewById(0x7f06015f);
        mHeaderProgress = (ProgressBar)mInnerLayout.findViewById(0x7f06015e);
        mSubHeaderText = (TextView)mInnerLayout.findViewById(0x7f060160);
        mHeaderImage = (ImageView)mInnerLayout.findViewById(0x7f06015d);
...
_L3:
        ...
        mPullLabel = context.getString(0x7f0c0001);
        mRefreshingLabel = context.getString(0x7f0c0003);
        mReleaseLabel = context.getString(0x7f0c0002);
_L6:
...
_L7:
        ...
        return;
_L2:
        LayoutInflater.from(context).inflate(0x7f03004c, this);
          goto _L5
_L4:
        if (orientation == com.handmark.pulltorefresh.library.PullToRefreshBase.Orientation.VERTICAL)
        {
        ...
        layoutparams.gravity = i;
        mPullLabel = context.getString(0x7f0c0004);
        mRefreshingLabel = context.getString(0x7f0c0006);
        mReleaseLabel = context.getString(0x7f0c0005);
          goto _L6
