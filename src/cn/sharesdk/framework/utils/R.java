...
public class R
{
    ...
    private static int a(String s, int i, int j, boolean flag)
    {
        int i1 = 0x80000000 / j;
        boolean flag1 = false;
        int j1 = s.length();
    ...
    private static Throwable b(String s)
    {
...
_L11:
    ...
    public static String encodeUrl(Bundle bundle)
    {
        ...
        while (iterator.hasNext()) 
        {
            ...
            stringbuilder.append((new StringBuilder()).append(cn.sharesdk.framework.utils.a.d(s)).append("=").append(cn.sharesdk.framework.utils.a.d(String.valueOf(obj))).toString());
        }
    ...
    public static String encodeUrl(ArrayList arraylist)
    {
        ...
        do
        {
            ...
            String s1 = ((f) (arraylist)).a;
            String s = (String)((f) (arraylist)).b;
            if (s1 != null)
            {
                arraylist = s;
                if (s == null)
                ...
                stringbuilder.append((new StringBuilder()).append(cn.sharesdk.framework.utils.a.d(s1)).append("=").append(cn.sharesdk.framework.utils.a.d(arraylist)).toString());
                i++;
            }
        } while (true);
        return stringbuilder.toString();
    ...
    public static String getCachePath(Context context, String s)
    {
        ...
        context = cn.sharesdk.framework.utils.b.a(context);
        if (context.w())
        {
            context = (new StringBuilder()).append(context.x()).append("/").append(((String) (obj))).append("/").append(context.q()).append("/cache/").toString();
        } else
        {
            context = s1;
        }
