    ...
    implements android.os.Handler.Callback
{
    private static class a
    {
        ...
        public a(Context context)
        {
            ...
            if (((cn.sharesdk.framework.utils.b) (obj)).w())
            {
                obj = new File(((cn.sharesdk.framework.utils.b) (obj)).x(), "ShareSDK");
                if (((File) (obj)).exists())
                {
                    a = new f();
            ...
            {
                cn.sharesdk.framework.utils.e.c(context);
            }
            if (a == null)
            {
                a = new f();
    ...
    private static class b extends Thread
    {
        ...
        public void run()
        {
            cn.sharesdk.framework.utils.b b1;
            Object obj1;
            b1 = cn.sharesdk.framework.utils.b.a(a);
            ArrayList arraylist = b1.a(false);
...
_L4:
            ...
            cn.sharesdk.framework.utils.e.a((new StringBuilder()).append("================== upload new removes: ").append(b1.q()).toString(), new Object[0]);
            cn.sharesdk.framework.statistics.a.a(a).a("UNINSTALL", ((ArrayList) (obj)));
            return;
_L2:
            if (((ArrayList) (obj1)).size() > 0)
            {
                cn.sharesdk.framework.utils.e.a((new StringBuilder()).append("================== upload new apps: ").append(b1.q()).toString(), new Object[0]);
                try
                {
                ...
                {
                    cn.sharesdk.framework.utils.e.c(throwable2);
                }
            }
...
_L2:
        ...
        if (true) goto _L2; else goto _L1
        context;
        cn.sharesdk.framework.utils.e.b(context);
_L1:
        cn/sharesdk/framework/statistics/NewAppReceiver;
        JVM INSTR monitorexit ;
        return;
...
_L1:
        context = cn.sharesdk.framework.utils.b.a(context).q();
...
_L6:
        if (flag)
        {
            cn.sharesdk.framework.utils.e.a((new StringBuilder()).append("========= receive broadcast: ").append(s).toString(), new Object[0]);
            e.removeMessages(1);
